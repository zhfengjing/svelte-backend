...
\`\`\``,
    ...
    await client.query(
      ...
      [
        ...
        JSON.stringify([
          { year: '2024', title: '高级全栈工程师', company: '某科技公司', description: '负责公司核心产品的前端架构设计，引入 Svelte 技术栈，性能提升 40%。' },
          { year: '2022', title: 'Web3 开发工程师', company: '区块链创业公司', description: '开发 DeFi 协议和 NFT 市场，累计处理交易额超过 1000 万美元。' },
          { year: '2020', title: '前端工程师', company: '互联网公司', description: '负责用户端 H5 页面开发，优化首屏加载速度，用户满意度提升 30%。' },
          { year: '2018', title: '初级开发工程师', company: '软件公司', description: '从事企业管理系统开发，积累了扎实的编程基础和工程实践经验。' },
        ]),
        JSON.stringify([
